    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 overflow-x-hidden">
            ...
            <div className="space-y-7">
              ...
              <div className="space-y-2 pt-1">
                {[
                  ...
                  <div key={s} className="flex items-center gap-2.5 text-sm text-zinc-500">
      ...
      <section className="relative z-10 border-t border-zinc-800/50">
        <div className="max-w-5xl mx-auto px-6 py-16">
          <Reveal>
            <p className="text-xs text-zinc-600 uppercase tracking-widest mb-3">The difference</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-10">
              Sound familiar?{' '}
              <span className="text-zinc-500">Here&apos;s what changes.</span>
            </h2>
          </Reveal>
      ...
      <section className="relative z-10 border-t border-zinc-800/50">
        <div className="max-w-5xl mx-auto px-6 py-16">
          <Reveal>
            <p className="text-xs text-zinc-600 uppercase tracking-widest mb-3">How Klippa helps</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-10">
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <Reveal key={i} delay={i * 0.08}>
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5 space-y-4 h-full">
                  <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                    {pillar.icon}
                  </div>
                  <div className="space-y-0.5">
                    <p className="text-xs text-zinc-600 line-through">{pillar.from}</p>
                    <p className="text-sm font-semibold text-zinc-100">{pillar.to}</p>
                  </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-16">
          <Reveal>
            <div className="space-y-3 mb-10">
              <p className="text-xs text-zinc-600 uppercase tracking-widest">Why Klippa is different</p>
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight">
                Not just a calculator.{' '}
                <span className="text-zinc-500">Your tax intelligence layer.</span>
              </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <Reveal key={i} delay={i * 0.08}>
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5 space-y-4 h-full flex flex-col">
      ...
      <section className="relative z-10 border-t border-zinc-800/50">
        <div className="max-w-5xl mx-auto px-6 py-16">
          <Reveal>
            <div className="space-y-3 mb-10">
              <p className="text-xs text-zinc-600 uppercase tracking-widest">The questions SARS won&apos;t answer for you</p>
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight">
                "What percentage can I actually claim?"{' '}
                <span className="text-zinc-500">Klippa tells you.</span>
              </h2>
            </div>
          </Reveal>
          ...
          <Reveal>
            ...
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                <span key={label} className="px-3.5 py-1.5 rounded-full border border-zinc-700/60 text-xs text-zinc-400 bg-zinc-900/60">
                  {label}
                </span>
              ))}
          ...
          <Reveal>
            <div className="text-center space-y-6 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                ...
                <span className="text-sm text-zinc-600">No credit card · No accountant needed</span>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <footer className="relative z-10 border-t border-zinc-800/40">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <p className="text-xs text-zinc-700">© 2025 Klippa. Built for South African taxpayers.</p>
        </div>
      </footer>
